...
function playRandomAudio() {
  ...
  playButton.style.display = 'none'; // Hide the "Click me" button
}

// Function to show the "Click me" button again
function showPlayButton() {
  const playButton = document.getElementById('playButton');
  playButton.style.display = 'block'; // Show the "Click me" button
}
...
function clearEditableParagraph() {
  editableParagraph.textContent = ''; // Clear the content
}
